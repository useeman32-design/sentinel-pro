...
const API = {
  ...
  admin: {
    ...
    translations: (lang) => API.request('/admin/translations?lang=' + lang),
    updateTranslation: (id, content) => API.request('/admin/translations/' + id, { method: 'PUT', body: { content } }),
    deleteTranslation: (id) => API.request('/admin/translations/' + id, { method: 'DELETE' }),
